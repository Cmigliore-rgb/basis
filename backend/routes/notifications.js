...
router.post('/send', requireAuth, async (req, res) => {
  ...
  const bodies = {
    budget_alert: `
      <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:24px">
        ...
        <p style="color:#888;font-size:13px;margin-top:24px">Open Basis to review your spending.</p>
      </div>`,
    goal_reached: `
      <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:24px">
        ...
        <p style="color:#888;font-size:13px;margin-top:24px">Log in to Basis to celebrate and set your next goal.</p>
      </div>`,
    low_balance: `
      <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:24px">
        ...
        <p style="color:#888;font-size:13px;margin-top:24px">Open Basis to review your accounts.</p>
      </div>`,
    test: `
      <div style="font-family:sans-serif;max-width:520px;margin:0 auto;padding:24px">
        <h2 style="color:#1a1a1a;margin-bottom:8px">Basis Notifications are working ✓</h2>
  ...
  try {
    await email.send({ to, subject: subject || 'Basis Alert', html: bodies[type] || bodies.test });
    res.json({ ok: true, to });
  } catch (e) {
